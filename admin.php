...
<body>
    <div class="container">
        ...
        <form method="post" action="home_insert.php">
            Header Top:<br>
            <input type="text" name="headerTop" value="<?php echo $fetchHome['headerTop']?>"><br>
            Header Bottom:<br>
            <input type="text" name="headerBottom" value="<?php echo $fetchHome['headerBottom']?>"><br>
            Summary:<br>
            <input type="text" name="summary" value="<?php echo $fetchHome['summary']?>"><br>
